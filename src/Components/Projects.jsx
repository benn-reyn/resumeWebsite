...
const projects = [
    ...
    },
    {
        ...
        description: "A series of different econometric analyses, from courses and independent research, with interactive visualizations and detailed explanations.",
